...
//            ((ViewGroup) findViewById(R.id.textViewAppSelectLine).getParent()).removeView(findViewById(R.id.textViewAppSelectLine));
    ...
    public void onClick(View v) {
        ...
        } else if (v.getTag().toString().equals("TrafficStatus")) {
            startActivity(new Intent(this, TrafficStatus.class));
        }
    }
    ...
    @Override
    public void onTrafficStatusUpdated(String traffic) {
        ((TextView) findViewById(R.id.TrafficStatusOverview)).setText(traffic);
    }
